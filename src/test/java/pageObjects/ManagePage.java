...
public class ManagePage extends BasePage {
	...
	@FindBy(xpath="//tr[1]//td[4]//button[@data-state='closed'][2]")
	WebElement btn_delete;
	
	@FindBy(xpath="//button[normalize-space()='Delete']")
	WebElement btn_ConfirmDelete;
	
	@FindBy(xpath="//tr[1]//td[4]//a[@href='/admin/school/dashboard/6961f07bf3dfdaf8a5f69680']")
	WebElement btn_View;
	
	@FindBy(xpath="//a[@href='/admin/school/teachers/6961f07bf3dfdaf8a5f69680']//span[normalize-space()='Teachers']")
	WebElement btn_Teachers;
	
	@FindBy(xpath="//a[@href='/admin/school/students/6961f07bf3dfdaf8a5f69680']//span[normalize-space()='Students']")
	WebElement btn_Students;
	
	@FindBy(xpath="//a[@href='/admin/school/admins/6961f07bf3dfdaf8a5f69680']//span[normalize-space()='Admins']")
	WebElement btn_Admins;
	
	@FindBy(xpath="//a[@href='/admin/school/class-management/6961f07bf3dfdaf8a5f69680']")
	WebElement btn_ClassManagement;
	
	@FindBy(xpath="//a[@href='/admin/school/sessions/6961f07bf3dfdaf8a5f69680']")
	WebElement btn_Sessions;
	
	@FindBy(xpath="//a[@href='/admin/school/cohorts/6961f07bf3dfdaf8a5f69680']//span[normalize-space()='Cohorts']")
...
//	}
	...
	public void Click_Admins() throws InterruptedException {
		Thread.sleep(2000);
		btn_Admins.click();
	}
	
	public void Click_ClassManagement() throws InterruptedException {
		for(int i=1;i>=2;i++) {
			Thread.sleep(2000);
			btn_ClassManagement.click();
			break;
		}
	}
